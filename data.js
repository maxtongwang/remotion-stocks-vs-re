...
// prettier-ignore
const DATA_THROUGH_YEAR = 2026, DATA_THROUGH_MONTH = 8; // DATA_THROUGH_MARKER
...
const SP500_PRICE = [
  ...
  0.1199, // 2026 (estimate — Bloomberg Wall St consensus)
  // SP500_CUR_END
];
...
const NB_ANN = [
  ...
  0.066, 0.063, 0.055, 0.057, 0.03, 0.031, 0.065, 0.239, 0.153, 0.045, 0.0311,
  // 2025–2026 (estimate)
  0.03, 0.03,
];
...
const RSF_ANN = [
  ...
  0.1,
  0.083,
  0.0217, // 2025 (estimate)
  0.043,
  0.0447, // 2026 (estimate)
];
...
const CORONADO_ANN = [
  ...
  0.235,
  0.097,
  0.0198, // 2025 (estimate)
  0.063,
  0.042,
  0.0406, // 2026 (estimate)
];
...
const LOSALTOS_ANN = [
  ...
  0.066,
  0.081,
  0.0173, // 2025 (estimate)
  0.031,
  0.027,
  -0.0305, // 2026 (estimate)
];
...
const CORALGABLES_ANN = [
  ...
  0.235,
  0.23,
  0.0147, // 2025 (estimate)
  0.09,
  0.041,
  0.0353, // 2026 (estimate)
];
...
const KEYBISCAYNE_ANN = [
  ...
  0.259,
  0.135,
  0.0163, // 2025 (estimate)
  0.042,
  0.0393, // 2026 (estimate)
];
...
const BRICKELL_ANN = [
  ...
  0.066,
  0.231,
  0.0144, // 2025 (estimate)
  0.118,
  0.089,
  0.04,
  0.0347, // 2026 (estimate)
];
...
const MEDINA_ANN = [
  ...
  0.244,
  0.057,
  0.0295, // 2025 (estimate)
  0.058,
  0.032,
  0.0042, // 2026 (estimate)
];
...
const BELLEVUE_ANN = [
  ...
  0.055,
  0.024,
  0.0259, // 2025 (estimate)
  0.031,
  0.0036, // 2026 (estimate)
];
...
const MANHATTAN_ANN = [
  ...
  0.051,
  0.041,
  0.0716, // 2025 (estimate)
  0.031,
  0.0712, // 2026 (estimate)
];
...
const HOBOKEN_ANN = [
  ...
  0.051,
  0.04,
  0.0684, // 2025 (estimate)
  0.03,
  0.0681, // 2026 (estimate)
];
...
const SCARSDALE_ANN = [
  ...
  0.051,
  0.04,
  0.0671, // 2025 (estimate)
  0.03,
  0.0668, // 2026 (estimate)
];
...
const SD_ANN = [
  ...
  // 2020–2024
  0.063, 0.206, 0.093, 0.077, 0.0178,
  // 2025 (estimate)
  0.0366,
  // 2026 (estimate)
  0.04,
...
const MIAMI_ANN = [
  ...
  // 2020–2024
  0.065, 0.214, 0.209, 0.109, 0.0137,
  // 2025 (estimate)
  0.033,
  // 2026 (estimate)
  0.04,
...
const DFW_ANN = [
  ...
  // 2020–2024
  0.049, 0.214, 0.149, 0.022, -0.0018,
  // 2025 (estimate)
  0.0059,
  // 2026 (estimate)
  0.02,
...
const SEATTLE_ANN = [
  ...
  // 2020–2024
  0.065, 0.177, 0.054, 0.024, 0.0227,
  // 2025 (estimate)
  0.0032,
  // 2026 (estimate)
  0.03,
...
const NASDAQ_PRICE = [
  ...
  0.128, // 2026 (estimate — Bloomberg analyst consensus)
  // NASDAQ_CUR_END
];
const NASDAQ_DIV = [
  // 1970–1993
