...
// prettier-ignore
const DATA_THROUGH_YEAR = 2026, DATA_THROUGH_MONTH = 5; // DATA_THROUGH_MARKER
...
const SP500_PRICE = [
  ...
  0.0973, // 2026 (estimate — Bloomberg Wall St consensus)
  // SP500_CUR_END
];
...
const NASDAQ_PRICE = [
  ...
  0.1349, // 2026 (estimate — Bloomberg analyst consensus)
  // NASDAQ_CUR_END
];
const NASDAQ_DIV = [
  // 1970–1993
